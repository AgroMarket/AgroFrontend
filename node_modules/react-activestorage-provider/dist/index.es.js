  ...
  createClass(ActiveStorageProvider, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          headers = _this$props.headers,
          props = objectWithoutProperties(_this$props, ["endpoint", "onSubmit", "headers"]);
    ...
    value: function () {
      ...
      regenerator.mark(function _callee2(signedIds) {
        var _this$props2, endpoint, multiple, headers, path, method, attribute, model, body, addCSRFHeader, response;

        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$props2 = this.props, endpoint = _this$props2.endpoint, multiple = _this$props2.multiple, headers = _this$props2.headers;
                ...
                addCSRFHeader = !headers || !headers.hasOwnProperty('X-CSRF-Token');
                _context2.next = 6;
                return fetch(path, {
                  credentials: 'same-origin',
                  method: method,
                  body: JSON.stringify(body),
                  headers: new Headers(objectSpread({
                    Accept: 'application/json',
                    'Content-Type': 'application/json'
                  }, addCSRFHeader ? csrfHeader() : {}, headers))
                });
